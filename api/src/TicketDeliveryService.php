...
final class TicketDeliveryService
{
    ...
    public function sendOrder(PDO $pdo, array $order, array $event, int $quantity): array
    {
        ...
        $this->mailer->queueOrderEmail($pdo, $orderId, (string) $order['email'], $subject, $body, $this->orderEmailHtml($order, $event, $quantity, $link, $isTest));
    ...
    private function orderEmailHtml(array $order, array $event, int $quantity, string $link, bool $isTest): string
    {
