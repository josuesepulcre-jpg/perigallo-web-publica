(function () {
  ...
  if (!window.PerigalloAnalytics && !document.querySelector('script[data-perigallo-analytics]')) {
    ...
    analyticsScript.dataset.perigalloAnalytics = "true";
  ...
  function initEventDetail() {
    ...
    if (!root) return;
    document.documentElement.classList.add("event-experience-page");
  ...
  function renderPerigalla01Landing(event, preview) {
    ...
    return [
      ...
      '<div class="perigalla-welcome-media"><img src="/la-perigalla-01/media/storytelling/perigalla-01/hosts/hosts-hero-v13-user-photo-cutout.png" alt="David y Josué, anfitriones de La Perigalla 01" width="1409" height="1116" loading="eager" fetchpriority="high"></div>',
  ...
  function renderEventDetail(event, preview) {
      ...
      return [
        ...
        '<section class="event-chapter event-chapter-entry" id="entrada" data-analytics-section="entradas">',
