(function () {
  ...
  function consentBanner() {
    ...
    style.textContent += ".pg-analytics-consent{border-radius:18px}.pg-analytics-consent div{gap:10px}.pg-analytics-consent button{display:inline-flex;align-items:center;justify-content:center;gap:10px;min-height:48px;padding:7px 8px 7px 17px;border-radius:999px;font-weight:600;letter-spacing:.14em;transition:transform .28s ease,background-color .28s ease,border-color .28s ease,box-shadow .28s ease}.pg-analytics-consent button::after{content:'→';display:grid;place-items:center;width:30px;height:30px;border:1px solid rgba(226,205,181,.32);border-radius:50%;font-size:15px;font-weight:400;letter-spacing:0;transition:transform .28s ease,background-color .28s ease}.pg-analytics-consent button[data-analytics-consent=granted]::after{border-color:transparent;background:rgba(23,50,54,.12)}.pg-analytics-consent button:hover,.pg-analytics-consent button:focus-visible{transform:translateY(-2px);border-color:#e2cdb5;box-shadow:0 10px 20px rgba(0,0,0,.2);outline:1px solid #cdb197;outline-offset:3px}.pg-analytics-consent button:hover::after,.pg-analytics-consent button:focus-visible::after{transform:translateX(3px)}@media(max-width:640px){.pg-analytics-consent button{min-height:48px;padding-left:14px;font-size:9px}}";
